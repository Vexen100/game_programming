...
Это всё ещё ручной прототип без procedural generation, sprite animations, sound, hit effects, полноценного QuestSystem, диалоговых окон, SaveManager, disk persistence и SettingsScene.
...
Это не означает, что игра готова. SaveManager, disk persistence, partial region resurgence while away, SettingsScene, Behavior Tree, BSP generation, sprites, animations и sound ещё не реализованы.
