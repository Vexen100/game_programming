...
Это всё ещё ручной прототип без procedural generation, sprite animations, sound, hit effects, полноценного QuestSystem, диалоговых окон, SaveManager и SettingsScene.
