...
Assault unlock стал сложнее: outpost alone и outpost + NPC quest без combat contribution больше не открывают штурм.

Ожидаемый путь к unlock теперь требует более полного регионального цикла: outpost, NPC quest и дополнительные enemy kills.
