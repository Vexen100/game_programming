...
Патруль, Behavior Tree, глобальные контратаки, оборона регионов и разные типы врагов ещё не реализованы.

Расширение A*/LOS за пределы `CastleAssaultScene`, Behavior Tree и более сложная оптимизация pathfinding ещё не реализованы.
