...
Патруль, LOS/hysteresis, Behavior Tree, глобальные контратаки, оборона регионов и разные типы врагов ещё не реализованы.

Расширение A* за пределы `CastleAssaultScene`, LOS/hysteresis и Behavior Tree ещё не реализованы.
