...
Это всё ещё ручной прототип: первый static PNG pass подключён, но полноценный production art pass, sprite animations, sound, hit effects, полноценный QuestSystem, диалоговые окна, multi-slot save UI, SettingsScene и procedural ordinary regions ещё не реализованы.
