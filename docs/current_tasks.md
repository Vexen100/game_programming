...
Это всё ещё ручной прототип: первый static PNG pass и базовый combat feedback подключены, но полноценный production art pass, sprite animations, sound, screen shake, полноценный QuestSystem, диалоговые окна, multi-slot save UI, SettingsScene и procedural ordinary regions ещё не реализованы.
