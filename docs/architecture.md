...
Текущий баланс `InfluenceSystem` требует более полного регионального цикла перед штурмом: outpost alone и outpost + quest без combat contribution не открывают assault.
