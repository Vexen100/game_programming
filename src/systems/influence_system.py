...
class InfluenceSystem:
    ...
    OUTPOST_CLEAR_PLAYER_INFLUENCE_GAIN = 35
    OUTPOST_CLEAR_ENEMY_INFLUENCE_LOSS = -35
    QUEST_COMPLETE_PLAYER_INFLUENCE_GAIN = 30
    QUEST_COMPLETE_ENEMY_INFLUENCE_LOSS = -30
